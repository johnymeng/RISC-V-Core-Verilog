...
#ifndef VERILATED_VSTEP7___024ROOT_H_
#define VERILATED_VSTEP7___024ROOT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vstep7___024root final : public VerilatedModule {
  public:
    ...
    IData/*31:0*/ bench__DOT__uut__DOT__myPC;
    ...
    // CONSTRUCTORS
    Vstep7___024root(Vstep7__Syms* symsp, const char* v__name);
    ~Vstep7___024root();
    VL_UNCOPYABLE(Vstep7___024root);
