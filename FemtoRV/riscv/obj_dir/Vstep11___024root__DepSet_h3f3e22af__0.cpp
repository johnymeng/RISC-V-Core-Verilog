...
VlCoroutine Vstep11___024root___eval_initial__TOP__Vtiming__0(Vstep11___024root* vlSelf);
...
void Vstep11___024root___eval_initial(Vstep11___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep11___024root___eval_initial\n"); );
    // Body
    Vstep11___024root___eval_initial__TOP(vlSelf);
    vlSelf->__Vm_traceActivity[1U] = 1U;
    Vstep11___024root___eval_initial__TOP__Vtiming__0(vlSelf);
...
VL_INLINE_OPT VlCoroutine Vstep11___024root___eval_initial__TOP__Vtiming__0(Vstep11___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep11__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep11___024root___eval_initial__TOP__Vtiming__0\n"); );
    // Body
    ...
    while (1U) {
        ...
        vlSelf->bench__DOT__prev_LEDS = (0x1fU & vlSelf->bench__DOT__uut__DOT__x1);
    }
}

void Vstep11___024root___eval_act(Vstep11___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep11__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep11___024root___eval_act\n"); );
}

void Vstep11___024root___nba_sequent__TOP__0(Vstep11___024root* vlSelf);
void Vstep11___024root___nba_sequent__TOP__1(Vstep11___024root* vlSelf);

void Vstep11___024root___eval_nba(Vstep11___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep11__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep11___024root___eval_nba\n"); );
    // Body
    if ((2ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vstep11___024root___nba_sequent__TOP__0(vlSelf);
    }
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vstep11___024root___nba_sequent__TOP__1(vlSelf);
        vlSelf->__Vm_traceActivity[2U] = 1U;
    }
}

VL_INLINE_OPT void Vstep11___024root___nba_sequent__TOP__0(Vstep11___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep11__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep11___024root___nba_sequent__TOP__0\n"); );
    // Body
...
VL_INLINE_OPT void Vstep11___024root___nba_sequent__TOP__1(Vstep11___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep11__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep11___024root___nba_sequent__TOP__1\n"); );
    // Init
    ...
    if ((2U == (IData)(vlSelf->bench__DOT__uut__DOT__CPU__DOT__state))) {
        if (((((((((0x33U == (0x7fU & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr)) 
            ...
            if (VL_UNLIKELY((0x33U == (0x7fU & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr)))) {
                VL_WRITEF_NX("ALUreg rd=%2# rs1=%2# rs2=%2# funct3=%b\n",0,
                             5,(0x1fU & (vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr 
                                         >> 7U)),5,
                             (0x1fU & (vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr 
                                       >> 0xfU)),5,
                             (0x1fU & (vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr 
                                       >> 0x14U)),3,
                             (7U & (vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr 
                                    >> 0xcU)));
                ...
                VL_WRITEF_NX("ALUimm rd=%2# rs1=%2# imm=%0# funct3=%b\n",0,
                             ...
                             3,(7U & (vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr 
                                      >> 0xcU)));
            } else if (VL_UNLIKELY((0x63U == (0x7fU 
                                              & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr)))) {
                VL_WRITEF_NX("BRANCH rs1=%0# rs2=%0#\n",0,
                             5,(0x1fU & (vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr 
                                         >> 0xfU)),
                             5,(0x1fU & (vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr 
                                         >> 0x14U)));
                ...
                VL_WRITEF_NX("JALR\n",0);
                                              ...
                                              & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr)))) {
                VL_WRITEF_NX("AUIPC\n",0);
            } else if ((0x37U == (0x7fU & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr))) {
                VL_WRITEF_NX("LUI\n",0);
            } else {
                VL_WRITEF_NX("LOAD\n",0);
            }
        } else if (VL_UNLIKELY((0x23U == (0x7fU & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr)))) {
            VL_WRITEF_NX("STORE\n",0);
        } else if (VL_UNLIKELY((0x73U == (0x7fU & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr)))) {
            VL_WRITEF_NX("SYSTEM\n",0);
        }
        if (VL_UNLIKELY((0x73U == (0x7fU & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr)))) {
            VL_FINISH_MT("step11.v", 233, "");
        }
    }
    if (VL_UNLIKELY(((IData)(vlSelf->bench__DOT__uut__DOT__CPU__DOT__writeBackEn) 
        ...
        if ((1U == (IData)(vlSelf->bench__DOT__uut__DOT__CPU__DOT__rdId))) {
            vlSelf->bench__DOT__uut__DOT__x1 = vlSelf->bench__DOT__uut__DOT__CPU__DOT__writeBackData;
        }
    }
...
void Vstep11___024root___timing_resume(Vstep11___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep11__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep11___024root___timing_resume\n"); );
    // Body
...
bool Vstep11___024root___eval_phase__act(Vstep11___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep11__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep11___024root___eval_phase__act\n"); );
    // Init
    VlTriggerVec<3> __VpreTriggered;
    CData/*0:0*/ __VactExecute;
    // Body
    Vstep11___024root___eval_triggers__act(vlSelf);
    __VactExecute = vlSelf->__VactTriggered.any();
    if (__VactExecute) {
        __VpreTriggered.andNot(vlSelf->__VactTriggered, vlSelf->__VnbaTriggered);
        vlSelf->__VnbaTriggered.thisOr(vlSelf->__VactTriggered);
        Vstep11___024root___timing_resume(vlSelf);
        Vstep11___024root___eval_act(vlSelf);
    }
    return (__VactExecute);
}

bool Vstep11___024root___eval_phase__nba(Vstep11___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep11__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep11___024root___eval_phase__nba\n"); );
    // Init
    CData/*0:0*/ __VnbaExecute;
    // Body
    __VnbaExecute = vlSelf->__VnbaTriggered.any();
    if (__VnbaExecute) {
        Vstep11___024root___eval_nba(vlSelf);
...
void Vstep11___024root___eval(Vstep11___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep11__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep11___024root___eval\n"); );
    // Init
    ...
    while (__VnbaContinue) {
...
#ifdef VL_DEBUG
            Vstep11___024root___dump_triggers__nba(vlSelf);
#endif
        ...
        while (vlSelf->__VactContinue) {
            ...
            if (Vstep11___024root___eval_phase__act(vlSelf)) {
                vlSelf->__VactContinue = 1U;
            }
        }
        if (Vstep11___024root___eval_phase__nba(vlSelf)) {
            __VnbaContinue = 1U;
        }
    }
}
...
void Vstep11___024root___eval_debug_assertions(Vstep11___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep11__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep11___024root___eval_debug_assertions\n"); );
}
#endif  // VL_DEBUG
