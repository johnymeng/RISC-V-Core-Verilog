...
void Vstep5___024root__trace_chg_0_sub_0(Vstep5___024root* vlSelf, VerilatedFst::Buffer* bufp);

void Vstep5___024root__trace_chg_0(void* voidSelf, VerilatedFst::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep5___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vstep5___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vstep5___024root__trace_chg_0_sub_0(Vstep5___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep5__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep5___024root__trace_chg_0_sub_0\n"); );
    // Init
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        bufp->chgIData(oldp+23,(vlSelf->bench__DOT__uut__DOT__rs1),32);
        bufp->chgIData(oldp+24,(vlSelf->bench__DOT__uut__DOT__rs2),32);
        bufp->chgCData(oldp+25,(vlSelf->bench__DOT__uut__DOT__state),2);
    }
    bufp->chgBit(oldp+26,(vlSelf->bench__DOT__CLK));
    bufp->chgCData(oldp+27,(vlSelf->bench__DOT__prev_LEDS),5);
    bufp->chgBit(oldp+28,(vlSelf->bench__DOT__uut__DOT__clk));
    bufp->chgIData(oldp+29,(vlSelf->bench__DOT__uut__DOT__CW__DOT__genblk1__DOT__slow_CLK),22);
}

void Vstep5___024root__trace_cleanup(void* voidSelf, VerilatedFst* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep5___024root__trace_cleanup\n"); );
    // Init
    Vstep5___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vstep5___024root*>(voidSelf);
    Vstep5__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
