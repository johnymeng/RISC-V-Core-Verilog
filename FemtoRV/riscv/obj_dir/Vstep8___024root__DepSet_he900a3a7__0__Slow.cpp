...
VL_ATTR_COLD void Vstep8___024root___eval_static__TOP(Vstep8___024root* vlSelf);

VL_ATTR_COLD void Vstep8___024root___eval_static(Vstep8___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep8__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep8___024root___eval_static\n"); );
    // Body
    Vstep8___024root___eval_static__TOP(vlSelf);
...
VL_ATTR_COLD void Vstep8___024root___eval_static__TOP(Vstep8___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep8__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep8___024root___eval_static__TOP\n"); );
    // Body
    vlSelf->bench__DOT__prev_LEDS = 0U;
    vlSelf->bench__DOT__uut__DOT__PC = 0U;
    vlSelf->bench__DOT__uut__DOT__L0_ = 4U;
    vlSelf->bench__DOT__uut__DOT__state = 0U;
    vlSelf->bench__DOT__uut__DOT__CW__DOT__genblk1__DOT__slow_CLK = 0U;
}

VL_ATTR_COLD void Vstep8___024root___eval_initial__TOP(Vstep8___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep8__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep8___024root___eval_initial__TOP\n"); );
    // Init
    IData/*31:0*/ __Vtask_bench__DOT__uut__DOT__Label__2__L;
    __Vtask_bench__DOT__uut__DOT__Label__2__L = 0;
    IData/*31:0*/ __Vtask_bench__DOT__uut__DOT__JAL__5__imm;
    __Vtask_bench__DOT__uut__DOT__JAL__5__imm = 0;
    IData/*31:0*/ __Vfunc_bench__DOT__uut__DOT__LabelRef__6__Vfuncout;
    __Vfunc_bench__DOT__uut__DOT__LabelRef__6__Vfuncout = 0;
    IData/*31:0*/ __Vfunc_bench__DOT__uut__DOT__LabelRef__6__L;
    __Vfunc_bench__DOT__uut__DOT__LabelRef__6__L = 0;
    IData/*31:0*/ __Vtask_bench__DOT__uut__DOT__JType__7__imm;
    __Vtask_bench__DOT__uut__DOT__JType__7__imm = 0;
    // Body
    vlSelf->bench__DOT__uut__DOT__MEM[0U] = 0xb3U;
    __Vtask_bench__DOT__uut__DOT__Label__2__L = vlSelf->bench__DOT__uut__DOT__L0_;
    vlSelf->bench__DOT__uut__DOT__L0_ = __Vtask_bench__DOT__uut__DOT__Label__2__L;
    vlSelf->bench__DOT__uut__DOT__MEM[1U] = 0x108093U;
    __Vfunc_bench__DOT__uut__DOT__LabelRef__6__L = vlSelf->bench__DOT__uut__DOT__L0_;
    __Vfunc_bench__DOT__uut__DOT__LabelRef__6__Vfuncout 
        = (__Vfunc_bench__DOT__uut__DOT__LabelRef__6__L 
           - (IData)(8U));
    __Vtask_bench__DOT__uut__DOT__JAL__5__imm = __Vfunc_bench__DOT__uut__DOT__LabelRef__6__Vfuncout;
    __Vtask_bench__DOT__uut__DOT__JType__7__imm = __Vtask_bench__DOT__uut__DOT__JAL__5__imm;
    vlSelf->bench__DOT__uut__DOT__MEM[2U] = (0x6fU 
                                             | ((0x80000000U 
                                                 & (__Vtask_bench__DOT__uut__DOT__JType__7__imm 
                                                    << 0xbU)) 
                                                | ((0x7fe00000U 
                                                    & (__Vtask_bench__DOT__uut__DOT__JType__7__imm 
                                                       << 0x14U)) 
                                                   | ((0x100000U 
                                                      ...
                                                      | (0xff000U 
                                                         & __Vtask_bench__DOT__uut__DOT__JType__7__imm)))));
    vlSelf->bench__DOT__uut__DOT__MEM[3U] = 0x100073U;
    vlSelf->bench__DOT__uut__DOT__memPC = 0x10U;
...
VL_ATTR_COLD void Vstep8___024root___eval_final(Vstep8___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep8__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep8___024root___eval_final\n"); );
}

#ifdef VL_DEBUG
VL_ATTR_COLD void Vstep8___024root___dump_triggers__stl(Vstep8___024root* vlSelf);
#endif  // VL_DEBUG
VL_ATTR_COLD bool Vstep8___024root___eval_phase__stl(Vstep8___024root* vlSelf);

VL_ATTR_COLD void Vstep8___024root___eval_settle(Vstep8___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep8__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep8___024root___eval_settle\n"); );
    // Init
    ...
    while (__VstlContinue) {
        ...
        __VstlContinue = 0U;
        if (Vstep8___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
VL_ATTR_COLD void Vstep8___024root___dump_triggers__stl(Vstep8___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep8__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep8___024root___dump_triggers__stl\n"); );
    // Body
...
VL_ATTR_COLD void Vstep8___024root___stl_sequent__TOP__0(Vstep8___024root* vlSelf);

VL_ATTR_COLD void Vstep8___024root___eval_stl(Vstep8___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep8__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep8___024root___eval_stl\n"); );
    // Body
    if ((1ULL & vlSelf->__VstlTriggered.word(0U))) {
        Vstep8___024root___stl_sequent__TOP__0(vlSelf);
        vlSelf->__Vm_traceActivity[2U] = 1U;
        vlSelf->__Vm_traceActivity[1U] = 1U;
        vlSelf->__Vm_traceActivity[0U] = 1U;
    }
...
VL_ATTR_COLD void Vstep8___024root___stl_sequent__TOP__0(Vstep8___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep8__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep8___024root___stl_sequent__TOP__0\n"); );
    // Body
    ...
    vlSelf->bench__DOT__uut__DOT__nextPC = ((0x6fU 
                                             == (0x7fU 
                                                 & vlSelf->bench__DOT__uut__DOT__instr))
...
VL_ATTR_COLD bool Vstep8___024root___eval_phase__stl(Vstep8___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep8__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep8___024root___eval_phase__stl\n"); );
    // Init
    CData/*0:0*/ __VstlExecute;
    // Body
    Vstep8___024root___eval_triggers__stl(vlSelf);
    __VstlExecute = vlSelf->__VstlTriggered.any();
    if (__VstlExecute) {
        Vstep8___024root___eval_stl(vlSelf);
    }
...
VL_ATTR_COLD void Vstep8___024root___dump_triggers__act(Vstep8___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep8__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep8___024root___dump_triggers__act\n"); );
    // Body
...
#ifdef VL_DEBUG
VL_ATTR_COLD void Vstep8___024root___dump_triggers__nba(Vstep8___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep8__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep8___024root___dump_triggers__nba\n"); );
    // Body
...
VL_ATTR_COLD void Vstep8___024root___ctor_var_reset(Vstep8___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep8__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep8___024root___ctor_var_reset\n"); );
    // Body
