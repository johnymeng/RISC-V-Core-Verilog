...
VL_ATTR_COLD void Vstep9___024root___eval_static__TOP(Vstep9___024root* vlSelf);

VL_ATTR_COLD void Vstep9___024root___eval_static(Vstep9___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep9__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep9___024root___eval_static\n"); );
    // Body
    Vstep9___024root___eval_static__TOP(vlSelf);
...
VL_ATTR_COLD void Vstep9___024root___eval_static__TOP(Vstep9___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep9__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep9___024root___eval_static__TOP\n"); );
    // Body
    vlSelf->bench__DOT__prev_LEDS = 0U;
    vlSelf->bench__DOT__uut__DOT__PC = 0U;
    vlSelf->bench__DOT__uut__DOT__L0_ = 8U;
...
VL_ATTR_COLD void Vstep9___024root___eval_initial__TOP(Vstep9___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep9__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep9___024root___eval_initial__TOP\n"); );
    // Init
    IData/*31:0*/ __Vtask_bench__DOT__uut__DOT__Label__4__L;
    __Vtask_bench__DOT__uut__DOT__Label__4__L = 0;
    IData/*31:0*/ __Vtask_bench__DOT__uut__DOT__BNE__7__imm;
    __Vtask_bench__DOT__uut__DOT__BNE__7__imm = 0;
    IData/*31:0*/ __Vfunc_bench__DOT__uut__DOT__LabelRef__8__Vfuncout;
    __Vfunc_bench__DOT__uut__DOT__LabelRef__8__Vfuncout = 0;
    IData/*31:0*/ __Vfunc_bench__DOT__uut__DOT__LabelRef__8__L;
    __Vfunc_bench__DOT__uut__DOT__LabelRef__8__L = 0;
    IData/*31:0*/ __Vtask_bench__DOT__uut__DOT__BType__9__imm;
    __Vtask_bench__DOT__uut__DOT__BType__9__imm = 0;
    // Body
    vlSelf->bench__DOT__uut__DOT__MEM[0U] = 0xb3U;
    vlSelf->bench__DOT__uut__DOT__MEM[1U] = 0x2000113U;
    __Vtask_bench__DOT__uut__DOT__Label__4__L = vlSelf->bench__DOT__uut__DOT__L0_;
    vlSelf->bench__DOT__uut__DOT__L0_ = __Vtask_bench__DOT__uut__DOT__Label__4__L;
    vlSelf->bench__DOT__uut__DOT__MEM[2U] = 0x108093U;
    __Vfunc_bench__DOT__uut__DOT__LabelRef__8__L = vlSelf->bench__DOT__uut__DOT__L0_;
    __Vfunc_bench__DOT__uut__DOT__LabelRef__8__Vfuncout 
        = (__Vfunc_bench__DOT__uut__DOT__LabelRef__8__L 
           - (IData)(0xcU));
    __Vtask_bench__DOT__uut__DOT__BNE__7__imm = __Vfunc_bench__DOT__uut__DOT__LabelRef__8__Vfuncout;
    __Vtask_bench__DOT__uut__DOT__BType__9__imm = __Vtask_bench__DOT__uut__DOT__BNE__7__imm;
    vlSelf->bench__DOT__uut__DOT__MEM[3U] = (0x209063U 
                                             | ((0x80000000U 
                                                 & (__Vtask_bench__DOT__uut__DOT__BType__9__imm 
                                                    << 0x13U)) 
                                                | ((0x7e000000U 
                                                    & (__Vtask_bench__DOT__uut__DOT__BType__9__imm 
                                                       << 0x14U)) 
                                                   | ((0xf00U 
                                                      ...
                                                      | (0x80U 
                                                         & (__Vtask_bench__DOT__uut__DOT__BType__9__imm 
                                                            >> 4U))))));
    vlSelf->bench__DOT__uut__DOT__MEM[4U] = 0x100073U;
    vlSelf->bench__DOT__uut__DOT__memPC = 0x14U;
...
VL_ATTR_COLD void Vstep9___024root___eval_final(Vstep9___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep9__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep9___024root___eval_final\n"); );
}

#ifdef VL_DEBUG
VL_ATTR_COLD void Vstep9___024root___dump_triggers__stl(Vstep9___024root* vlSelf);
#endif  // VL_DEBUG
VL_ATTR_COLD bool Vstep9___024root___eval_phase__stl(Vstep9___024root* vlSelf);

VL_ATTR_COLD void Vstep9___024root___eval_settle(Vstep9___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep9__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep9___024root___eval_settle\n"); );
    // Init
...
#ifdef VL_DEBUG
            Vstep9___024root___dump_triggers__stl(vlSelf);
#endif
            VL_FATAL_MT("bench_iverilog.v", 1, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (Vstep9___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
VL_ATTR_COLD void Vstep9___024root___dump_triggers__stl(Vstep9___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep9__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep9___024root___dump_triggers__stl\n"); );
    // Body
...
VL_ATTR_COLD void Vstep9___024root___stl_sequent__TOP__0(Vstep9___024root* vlSelf);

VL_ATTR_COLD void Vstep9___024root___eval_stl(Vstep9___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep9__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep9___024root___eval_stl\n"); );
    // Body
    if ((1ULL & vlSelf->__VstlTriggered.word(0U))) {
        Vstep9___024root___stl_sequent__TOP__0(vlSelf);
        vlSelf->__Vm_traceActivity[2U] = 1U;
        vlSelf->__Vm_traceActivity[1U] = 1U;
        vlSelf->__Vm_traceActivity[0U] = 1U;
    }
...
VL_ATTR_COLD void Vstep9___024root___stl_sequent__TOP__0(Vstep9___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep9__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep9___024root___stl_sequent__TOP__0\n"); );
    // Body
...
VL_ATTR_COLD void Vstep9___024root___eval_triggers__stl(Vstep9___024root* vlSelf);

VL_ATTR_COLD bool Vstep9___024root___eval_phase__stl(Vstep9___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep9__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep9___024root___eval_phase__stl\n"); );
    // Init
    CData/*0:0*/ __VstlExecute;
    // Body
    Vstep9___024root___eval_triggers__stl(vlSelf);
    __VstlExecute = vlSelf->__VstlTriggered.any();
    if (__VstlExecute) {
        Vstep9___024root___eval_stl(vlSelf);
    }
...
VL_ATTR_COLD void Vstep9___024root___dump_triggers__act(Vstep9___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep9__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep9___024root___dump_triggers__act\n"); );
    // Body
...
VL_ATTR_COLD void Vstep9___024root___dump_triggers__nba(Vstep9___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep9__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep9___024root___dump_triggers__nba\n"); );
    // Body
...
VL_ATTR_COLD void Vstep9___024root___ctor_var_reset(Vstep9___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep9__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep9___024root___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->bench__DOT__uut__DOT__L0_ = VL_RAND_RESET_I(32);
    vlSelf->bench__DOT__uut__DOT__isSYSTEM = VL_RAND_RESET_I(1);
    vlSelf->bench__DOT__uut__DOT__Iimm = VL_RAND_RESET_I(32);
    ...
    vlSelf->bench__DOT__uut__DOT__writeBackData = VL_RAND_RESET_I(32);
    ...
    vlSelf->bench__DOT__uut__DOT__nextPC = VL_RAND_RESET_I(32);
    vlSelf->bench__DOT__uut__DOT____VdfgRegularize_h2f053c4c_0_4 = VL_RAND_RESET_I(1);
