...
void Vstep15___024root__trace_chg_0_sub_0(Vstep15___024root* vlSelf, VerilatedFst::Buffer* bufp);

void Vstep15___024root__trace_chg_0(void* voidSelf, VerilatedFst::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep15___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vstep15___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vstep15___024root__trace_chg_0_sub_0(Vstep15___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep15__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep15___024root__trace_chg_0_sub_0\n"); );
    // Init
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgIData(oldp+39,((((1U == (IData)(vlSelf->bench__DOT__uut__DOT__CPU__DOT__state)) 
        ...
        bufp->chgIData(oldp+43,(vlSelf->bench__DOT__uut__DOT__CPU__DOT__PC),32);
        bufp->chgIData(oldp+44,(vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr),32);
        bufp->chgBit(oldp+45,((0x33U == (0x7fU & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr))));
        bufp->chgBit(oldp+46,((0x13U == (0x7fU & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr))));
        bufp->chgBit(oldp+47,((0x63U == (0x7fU & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr))));
        bufp->chgBit(oldp+48,((0x67U == (0x7fU & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr))));
        bufp->chgBit(oldp+49,((0x6fU == (0x7fU & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr))));
        bufp->chgBit(oldp+50,((0x17U == (0x7fU & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr))));
        bufp->chgBit(oldp+51,((0x37U == (0x7fU & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr))));
        bufp->chgBit(oldp+52,((3U == (0x7fU & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr))));
        bufp->chgBit(oldp+53,((0x23U == (0x7fU & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr))));
        bufp->chgBit(oldp+54,((0x73U == (0x7fU & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr))));
        bufp->chgIData(oldp+55,((0xfffff000U & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr)),32);
        bufp->chgIData(oldp+56,(vlSelf->bench__DOT__uut__DOT__CPU__DOT__Iimm),32);
                                  ...
                                  << 0xcU) | ((0x800U 
                                              ...
                                              | ((0x7e0U 
                                                 ...
                                                 | (0x1eU 
                                                    & (vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr 
                                                       >> 7U)))))),32);
        bufp->chgIData(oldp+59,((((- (IData)((vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr 
                                              >> 0x1fU))) 
                                  << 0x14U) | ((0xff000U 
                                                & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr) 
                                               | ((0x800U 
        ...
        bufp->chgCData(oldp+61,((0x1fU & (vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr 
                                          >> 0x14U))),5);
        bufp->chgCData(oldp+62,((0x1fU & (vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr 
                                          >> 7U))),5);
        bufp->chgCData(oldp+63,((7U & (vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr 
                                       >> 0xcU))),3);
        bufp->chgCData(oldp+64,((vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr 
                                 >> 0x19U)),7);
        bufp->chgIData(oldp+65,(vlSelf->bench__DOT__uut__DOT__CPU__DOT__rs1),32);
        bufp->chgIData(oldp+66,(vlSelf->bench__DOT__uut__DOT__CPU__DOT__rs2),32);
        bufp->chgIData(oldp+67,(vlSelf->bench__DOT__uut__DOT__CPU__DOT__writeBackData),32);
        bufp->chgBit(oldp+68,((((0x63U != (0x7fU & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr)) 
                                & ((~ ((0x23U == (0x7fU 
                                                  & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr)) 
                                       | (3U == (0x7fU 
                                                 & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr)))) 
        ...
        bufp->chgIData(oldp+69,(vlSelf->bench__DOT__uut__DOT__CPU__DOT__aluIn2),32);
        bufp->chgCData(oldp+70,((0x1fU & ((0x33U == 
                                           (0x7fU & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr))
                                           ? vlSelf->bench__DOT__uut__DOT__CPU__DOT__rs2
                                           : (vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr 
                                              >> 0x14U)))),5);
        bufp->chgIData(oldp+71,(vlSelf->bench__DOT__uut__DOT__CPU__DOT__aluPlus),32);
        bufp->chgQData(oldp+72,(vlSelf->bench__DOT__uut__DOT__CPU__DOT__aluMinus),33);
        bufp->chgBit(oldp+74,(vlSelf->bench__DOT__uut__DOT__CPU__DOT__LT));
        bufp->chgBit(oldp+75,((1U & (IData)((vlSelf->bench__DOT__uut__DOT__CPU__DOT__aluMinus 
                                             >> 0x20U)))));
        bufp->chgBit(oldp+76,((0U == (IData)(vlSelf->bench__DOT__uut__DOT__CPU__DOT__aluMinus))));
        bufp->chgIData(oldp+77,(vlSelf->bench__DOT__uut__DOT__CPU__DOT__shifter_in),32);
        bufp->chgIData(oldp+78,(vlSelf->bench__DOT__uut__DOT__CPU__DOT__shifter),32);
        bufp->chgIData(oldp+79,(vlSelf->bench__DOT__uut__DOT__CPU__DOT__leftshift),32);
        bufp->chgIData(oldp+80,(((0x4000U & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr)
        ...
        bufp->chgBit(oldp+81,(vlSelf->bench__DOT__uut__DOT__CPU__DOT__takeBranch));
        bufp->chgIData(oldp+82,(vlSelf->bench__DOT__uut__DOT__CPU__DOT__PCplusImm),32);
        bufp->chgIData(oldp+83,(((IData)(4U) + vlSelf->bench__DOT__uut__DOT__CPU__DOT__PC)),32);
        bufp->chgIData(oldp+84,(((((0x63U == (0x7fU 
                                              & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr)) 
        ...
        bufp->chgIData(oldp+85,(vlSelf->bench__DOT__uut__DOT__CPU__DOT__loadstore_addr),32);
        bufp->chgBit(oldp+86,((0U == (3U & (vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr 
                                            >> 0xcU)))));
        bufp->chgBit(oldp+87,((1U == (3U & (vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr 
                                            >> 0xcU)))));
        bufp->chgSData(oldp+88,(vlSelf->bench__DOT__uut__DOT__CPU__DOT__LOAD_halfword),16);
        bufp->chgCData(oldp+89,(vlSelf->bench__DOT__uut__DOT__CPU__DOT__LOAD_byte),8);
        bufp->chgBit(oldp+90,(vlSelf->bench__DOT__uut__DOT__CPU__DOT__LOAD_sign));
        bufp->chgIData(oldp+91,(((0U == (3U & (vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr 
                                               >> 0xcU)))
        ...
        bufp->chgCData(oldp+92,(vlSelf->bench__DOT__uut__DOT__CPU__DOT__state),3);
        bufp->chgSData(oldp+93,(vlSelf->bench__DOT__uut__DOT__CW__DOT__genblk1__DOT__reset_cnt),16);
    }
    bufp->chgBit(oldp+94,(vlSelf->bench__DOT__CLK));
    bufp->chgCData(oldp+95,(vlSelf->bench__DOT__prev_LEDS),5);
}

void Vstep15___024root__trace_cleanup(void* voidSelf, VerilatedFst* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep15___024root__trace_cleanup\n"); );
    // Init
    Vstep15___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vstep15___024root*>(voidSelf);
    Vstep15__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
