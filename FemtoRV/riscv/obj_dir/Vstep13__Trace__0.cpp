...
void Vstep13___024root__trace_chg_0_sub_0(Vstep13___024root* vlSelf, VerilatedFst::Buffer* bufp);

void Vstep13___024root__trace_chg_0(void* voidSelf, VerilatedFst::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep13___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vstep13___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vstep13___024root__trace_chg_0_sub_0(Vstep13___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep13__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep13___024root__trace_chg_0_sub_0\n"); );
    // Init
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgIData(oldp+55,(vlSelf->bench__DOT__uut__DOT__CPU__DOT__Iimm),32);
        ...
        bufp->chgBit(oldp+67,(((3U == (IData)(vlSelf->bench__DOT__uut__DOT__CPU__DOT__state)) 
                               & ((0x33U == (0x7fU 
                                             & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr)) 
                                  | ((0x13U == (0x7fU 
                                                & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr)) 
        ...
        bufp->chgIData(oldp+69,(((0x4000U & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr)
        ...
        bufp->chgCData(oldp+70,(vlSelf->bench__DOT__uut__DOT__CPU__DOT__shamt),5);
        bufp->chgBit(oldp+71,(((0x4000U & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr)
                                ? ((0x2000U & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr)
                                    ? ((0x1000U & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr)
                                        ? (vlSelf->bench__DOT__uut__DOT__CPU__DOT__rs1 
                                ...
                                : ((1U & (~ (vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr 
                                   ...
                                   && ((0x1000U & vlSelf->bench__DOT__uut__DOT__CPU__DOT__instr)
                                        ...
                                        : (vlSelf->bench__DOT__uut__DOT__CPU__DOT__rs1 
                                           == vlSelf->bench__DOT__uut__DOT__CPU__DOT__rs2))))));
        bufp->chgCData(oldp+72,(vlSelf->bench__DOT__uut__DOT__CPU__DOT__state),2);
        bufp->chgIData(oldp+73,(vlSelf->bench__DOT__uut__DOT__CPU__DOT__nextPC),32);
        bufp->chgSData(oldp+74,(vlSelf->bench__DOT__uut__DOT__CW__DOT__genblk1__DOT__reset_cnt),16);
    }
    bufp->chgBit(oldp+75,(vlSelf->bench__DOT__CLK));
    bufp->chgCData(oldp+76,(vlSelf->bench__DOT__prev_LEDS),5);
}

void Vstep13___024root__trace_cleanup(void* voidSelf, VerilatedFst* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep13___024root__trace_cleanup\n"); );
    // Init
    Vstep13___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vstep13___024root*>(voidSelf);
    Vstep13__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
