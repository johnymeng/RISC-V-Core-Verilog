...
void Vstep4___024root___eval_triggers__act(Vstep4___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep4___024root___eval_triggers__act\n"); );
    // Body
    vlSelf->__VactTriggered.set(0U, ((IData)(vlSelf->tb__DOT__uut__DOT__clk) 
                                     & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__tb__DOT__uut__DOT__clk__0))));
