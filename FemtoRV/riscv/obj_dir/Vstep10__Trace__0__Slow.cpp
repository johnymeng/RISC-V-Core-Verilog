...
VL_ATTR_COLD void Vstep10___024root__trace_init_sub__TOP__0(Vstep10___024root* vlSelf, VerilatedFst* tracep) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep10__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep10___024root__trace_init_sub__TOP__0\n"); );
    // Init
    ...
    tracep->declBus(c+33,0,"LEDS",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 4,0);
    ...
    tracep->declBus(c+67,0,"prev_LEDS",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 4,0);
    ...
    tracep->declBus(c+33,0,"LEDS",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 4,0);
    ...
    tracep->declBit(c+68,0,"clk",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+33,0,"leds",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 4,0);
    ...
    tracep->declBus(c+61,0,"aluOut",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+62,0,"shamt",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 4,0);
    tracep->declBit(c+63,0,"takeBranch",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+65,0,"nextPC",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+70,0,"memPC",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::INTEGER, false,-1, 31,0);
    ...
    tracep->declBit(c+66,0,"CLK",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+72,0,"RESET",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+68,0,"clk",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
...
VL_ATTR_COLD void Vstep10___024root__trace_init_top(Vstep10___024root* vlSelf, VerilatedFst* tracep) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep10__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep10___024root__trace_init_top\n"); );
    // Body
    Vstep10___024root__trace_init_sub__TOP__0(vlSelf, tracep);
}

VL_ATTR_COLD void Vstep10___024root__trace_const_0(void* voidSelf, VerilatedFst::Buffer* bufp);
VL_ATTR_COLD void Vstep10___024root__trace_full_0(void* voidSelf, VerilatedFst::Buffer* bufp);
void Vstep10___024root__trace_chg_0(void* voidSelf, VerilatedFst::Buffer* bufp);
void Vstep10___024root__trace_cleanup(void* voidSelf, VerilatedFst* /*unused*/);

VL_ATTR_COLD void Vstep10___024root__trace_register(Vstep10___024root* vlSelf, VerilatedFst* tracep) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep10__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep10___024root__trace_register\n"); );
    // Body
    tracep->addConstCb(&Vstep10___024root__trace_const_0, 0U, vlSelf);
    tracep->addFullCb(&Vstep10___024root__trace_full_0, 0U, vlSelf);
    tracep->addChgCb(&Vstep10___024root__trace_chg_0, 0U, vlSelf);
    tracep->addCleanupCb(&Vstep10___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void Vstep10___024root__trace_const_0_sub_0(Vstep10___024root* vlSelf, VerilatedFst::Buffer* bufp);

VL_ATTR_COLD void Vstep10___024root__trace_const_0(void* voidSelf, VerilatedFst::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep10___024root__trace_const_0\n"); );
    // Init
    Vstep10___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vstep10___024root*>(voidSelf);
    Vstep10__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    Vstep10___024root__trace_const_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vstep10___024root__trace_const_0_sub_0(Vstep10___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep10__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep10___024root__trace_const_0_sub_0\n"); );
    // Init
...
VL_ATTR_COLD void Vstep10___024root__trace_full_0_sub_0(Vstep10___024root* vlSelf, VerilatedFst::Buffer* bufp);

VL_ATTR_COLD void Vstep10___024root__trace_full_0(void* voidSelf, VerilatedFst::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep10___024root__trace_full_0\n"); );
    // Init
    Vstep10___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vstep10___024root*>(voidSelf);
    Vstep10__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    Vstep10___024root__trace_full_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vstep10___024root__trace_full_0_sub_0(Vstep10___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep10__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep10___024root__trace_full_0_sub_0\n"); );
    // Init
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode);
    // Body
    bufp->fullIData(oldp+1,(vlSelf->bench__DOT__uut__DOT__RegisterBank[0]),32);
    bufp->fullIData(oldp+2,(vlSelf->bench__DOT__uut__DOT__RegisterBank[1]),32);
    bufp->fullIData(oldp+3,(vlSelf->bench__DOT__uut__DOT__RegisterBank[2]),32);
    bufp->fullIData(oldp+4,(vlSelf->bench__DOT__uut__DOT__RegisterBank[3]),32);
    bufp->fullIData(oldp+5,(vlSelf->bench__DOT__uut__DOT__RegisterBank[4]),32);
    bufp->fullIData(oldp+6,(vlSelf->bench__DOT__uut__DOT__RegisterBank[5]),32);
    bufp->fullIData(oldp+7,(vlSelf->bench__DOT__uut__DOT__RegisterBank[6]),32);
    bufp->fullIData(oldp+8,(vlSelf->bench__DOT__uut__DOT__RegisterBank[7]),32);
    bufp->fullIData(oldp+9,(vlSelf->bench__DOT__uut__DOT__RegisterBank[8]),32);
    bufp->fullIData(oldp+10,(vlSelf->bench__DOT__uut__DOT__RegisterBank[9]),32);
    bufp->fullIData(oldp+11,(vlSelf->bench__DOT__uut__DOT__RegisterBank[10]),32);
    bufp->fullIData(oldp+12,(vlSelf->bench__DOT__uut__DOT__RegisterBank[11]),32);
    bufp->fullIData(oldp+13,(vlSelf->bench__DOT__uut__DOT__RegisterBank[12]),32);
    bufp->fullIData(oldp+14,(vlSelf->bench__DOT__uut__DOT__RegisterBank[13]),32);
    bufp->fullIData(oldp+15,(vlSelf->bench__DOT__uut__DOT__RegisterBank[14]),32);
    bufp->fullIData(oldp+16,(vlSelf->bench__DOT__uut__DOT__RegisterBank[15]),32);
    bufp->fullIData(oldp+17,(vlSelf->bench__DOT__uut__DOT__RegisterBank[16]),32);
    bufp->fullIData(oldp+18,(vlSelf->bench__DOT__uut__DOT__RegisterBank[17]),32);
    bufp->fullIData(oldp+19,(vlSelf->bench__DOT__uut__DOT__RegisterBank[18]),32);
    bufp->fullIData(oldp+20,(vlSelf->bench__DOT__uut__DOT__RegisterBank[19]),32);
    bufp->fullIData(oldp+21,(vlSelf->bench__DOT__uut__DOT__RegisterBank[20]),32);
    bufp->fullIData(oldp+22,(vlSelf->bench__DOT__uut__DOT__RegisterBank[21]),32);
    bufp->fullIData(oldp+23,(vlSelf->bench__DOT__uut__DOT__RegisterBank[22]),32);
    bufp->fullIData(oldp+24,(vlSelf->bench__DOT__uut__DOT__RegisterBank[23]),32);
    bufp->fullIData(oldp+25,(vlSelf->bench__DOT__uut__DOT__RegisterBank[24]),32);
    bufp->fullIData(oldp+26,(vlSelf->bench__DOT__uut__DOT__RegisterBank[25]),32);
    bufp->fullIData(oldp+27,(vlSelf->bench__DOT__uut__DOT__RegisterBank[26]),32);
    bufp->fullIData(oldp+28,(vlSelf->bench__DOT__uut__DOT__RegisterBank[27]),32);
    bufp->fullIData(oldp+29,(vlSelf->bench__DOT__uut__DOT__RegisterBank[28]),32);
    bufp->fullIData(oldp+30,(vlSelf->bench__DOT__uut__DOT__RegisterBank[29]),32);
    bufp->fullIData(oldp+31,(vlSelf->bench__DOT__uut__DOT__RegisterBank[30]),32);
    bufp->fullIData(oldp+32,(vlSelf->bench__DOT__uut__DOT__RegisterBank[31]),32);
    bufp->fullCData(oldp+33,(vlSelf->bench__DOT__uut__DOT__leds),5);
    bufp->fullIData(oldp+34,(vlSelf->bench__DOT__uut__DOT__PC),32);
    ...
    bufp->fullIData(oldp+47,(vlSelf->bench__DOT__uut__DOT__Iimm),32);
    ...
    bufp->fullIData(oldp+58,(vlSelf->bench__DOT__uut__DOT__writeBackData),32);
    ...
    bufp->fullIData(oldp+61,(((0x4000U & vlSelf->bench__DOT__uut__DOT__instr)
    ...
    bufp->fullCData(oldp+62,(vlSelf->bench__DOT__uut__DOT__shamt),5);
    bufp->fullBit(oldp+63,(((0x4000U & vlSelf->bench__DOT__uut__DOT__instr)
                             ? ((0x2000U & vlSelf->bench__DOT__uut__DOT__instr)
                                 ? ((0x1000U & vlSelf->bench__DOT__uut__DOT__instr)
                                     ? (vlSelf->bench__DOT__uut__DOT__rs1 
                             ...
                             : ((1U & (~ (vlSelf->bench__DOT__uut__DOT__instr 
                                ...
                                && ((0x1000U & vlSelf->bench__DOT__uut__DOT__instr)
                                     ...
                                     : (vlSelf->bench__DOT__uut__DOT__rs1 
                                        == vlSelf->bench__DOT__uut__DOT__rs2))))));
    bufp->fullCData(oldp+64,(vlSelf->bench__DOT__uut__DOT__state),2);
    bufp->fullIData(oldp+65,(vlSelf->bench__DOT__uut__DOT__nextPC),32);
    bufp->fullBit(oldp+66,(vlSelf->bench__DOT__CLK));
    bufp->fullCData(oldp+67,(vlSelf->bench__DOT__prev_LEDS),5);
    bufp->fullBit(oldp+68,(vlSelf->bench__DOT__uut__DOT__clk));
    bufp->fullIData(oldp+69,(vlSelf->bench__DOT__uut__DOT__i),32);
    bufp->fullIData(oldp+70,(vlSelf->bench__DOT__uut__DOT__memPC),32);
