...
void Vstep9___024root__trace_chg_0_sub_0(Vstep9___024root* vlSelf, VerilatedFst::Buffer* bufp);

void Vstep9___024root__trace_chg_0(void* voidSelf, VerilatedFst::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep9___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vstep9___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vstep9___024root__trace_chg_0_sub_0(Vstep9___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep9__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep9___024root__trace_chg_0_sub_0\n"); );
    // Init
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgBit(oldp+65,(((0x4000U & vlSelf->bench__DOT__uut__DOT__instr)
                                ? ((0x2000U & vlSelf->bench__DOT__uut__DOT__instr)
                                    ? ((0x1000U & vlSelf->bench__DOT__uut__DOT__instr)
                                        ? (vlSelf->bench__DOT__uut__DOT__rs1 
                                ...
                                : ((1U & (~ (vlSelf->bench__DOT__uut__DOT__instr 
                                   ...
                                   && ((0x1000U & vlSelf->bench__DOT__uut__DOT__instr)
                                        ...
                                        : (vlSelf->bench__DOT__uut__DOT__rs1 
                                           == vlSelf->bench__DOT__uut__DOT__rs2))))));
        bufp->chgCData(oldp+66,(vlSelf->bench__DOT__uut__DOT__state),2);
        bufp->chgIData(oldp+67,(vlSelf->bench__DOT__uut__DOT__nextPC),32);
    }
    bufp->chgBit(oldp+68,(vlSelf->bench__DOT__CLK));
    bufp->chgCData(oldp+69,(vlSelf->bench__DOT__prev_LEDS),5);
    bufp->chgBit(oldp+70,(vlSelf->bench__DOT__uut__DOT__clk));
    bufp->chgIData(oldp+71,(vlSelf->bench__DOT__uut__DOT__CW__DOT__genblk1__DOT__slow_CLK),20);
}

void Vstep9___024root__trace_cleanup(void* voidSelf, VerilatedFst* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep9___024root__trace_cleanup\n"); );
    // Init
    Vstep9___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vstep9___024root*>(voidSelf);
    Vstep9__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
