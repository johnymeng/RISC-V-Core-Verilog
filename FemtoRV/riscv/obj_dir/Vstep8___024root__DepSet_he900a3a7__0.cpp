...
VlCoroutine Vstep8___024root___eval_initial__TOP__Vtiming__0(Vstep8___024root* vlSelf);
...
void Vstep8___024root___eval_initial(Vstep8___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep8___024root___eval_initial\n"); );
    // Body
    Vstep8___024root___eval_initial__TOP(vlSelf);
    vlSelf->__Vm_traceActivity[1U] = 1U;
    Vstep8___024root___eval_initial__TOP__Vtiming__0(vlSelf);
...
VL_INLINE_OPT VlCoroutine Vstep8___024root___eval_initial__TOP__Vtiming__0(Vstep8___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep8__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep8___024root___eval_initial__TOP__Vtiming__0\n"); );
    // Body
...
void Vstep8___024root___eval_act(Vstep8___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep8__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep8___024root___eval_act\n"); );
}

void Vstep8___024root___nba_sequent__TOP__0(Vstep8___024root* vlSelf);
void Vstep8___024root___nba_sequent__TOP__1(Vstep8___024root* vlSelf);

void Vstep8___024root___eval_nba(Vstep8___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep8__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep8___024root___eval_nba\n"); );
    // Body
    if ((2ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vstep8___024root___nba_sequent__TOP__0(vlSelf);
    }
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vstep8___024root___nba_sequent__TOP__1(vlSelf);
        vlSelf->__Vm_traceActivity[2U] = 1U;
    }
}

VL_INLINE_OPT void Vstep8___024root___nba_sequent__TOP__0(Vstep8___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep8__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep8___024root___nba_sequent__TOP__0\n"); );
    // Body
...
VL_INLINE_OPT void Vstep8___024root___nba_sequent__TOP__1(Vstep8___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep8__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep8___024root___nba_sequent__TOP__1\n"); );
    // Init
...
void Vstep8___024root___timing_resume(Vstep8___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep8__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep8___024root___timing_resume\n"); );
    // Body
...
bool Vstep8___024root___eval_phase__act(Vstep8___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep8__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep8___024root___eval_phase__act\n"); );
    // Init
    VlTriggerVec<3> __VpreTriggered;
    CData/*0:0*/ __VactExecute;
    // Body
    Vstep8___024root___eval_triggers__act(vlSelf);
    __VactExecute = vlSelf->__VactTriggered.any();
    if (__VactExecute) {
        __VpreTriggered.andNot(vlSelf->__VactTriggered, vlSelf->__VnbaTriggered);
        vlSelf->__VnbaTriggered.thisOr(vlSelf->__VactTriggered);
        Vstep8___024root___timing_resume(vlSelf);
        Vstep8___024root___eval_act(vlSelf);
    }
    return (__VactExecute);
}

bool Vstep8___024root___eval_phase__nba(Vstep8___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep8__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep8___024root___eval_phase__nba\n"); );
    // Init
    CData/*0:0*/ __VnbaExecute;
    // Body
    __VnbaExecute = vlSelf->__VnbaTriggered.any();
    if (__VnbaExecute) {
        Vstep8___024root___eval_nba(vlSelf);
...
void Vstep8___024root___eval(Vstep8___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep8__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep8___024root___eval\n"); );
    // Init
    ...
    while (__VnbaContinue) {
...
#ifdef VL_DEBUG
            Vstep8___024root___dump_triggers__nba(vlSelf);
#endif
        ...
        while (vlSelf->__VactContinue) {
            ...
            if (Vstep8___024root___eval_phase__act(vlSelf)) {
                vlSelf->__VactContinue = 1U;
            }
        }
        if (Vstep8___024root___eval_phase__nba(vlSelf)) {
            __VnbaContinue = 1U;
        }
    }
}
...
void Vstep8___024root___eval_debug_assertions(Vstep8___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vstep8__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstep8___024root___eval_debug_assertions\n"); );
}
#endif  // VL_DEBUG
