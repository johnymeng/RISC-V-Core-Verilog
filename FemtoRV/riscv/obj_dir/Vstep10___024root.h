...
#ifndef VERILATED_VSTEP10___024ROOT_H_
#define VERILATED_VSTEP10___024ROOT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vstep10___024root final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vstep10___024root(Vstep10__Syms* symsp, const char* v__name);
    ~Vstep10___024root();
    VL_UNCOPYABLE(Vstep10___024root);
